...
if __name__ == "__main__":
    iterationsSEG1, yieldsSEG1 = readFromFile("300_trials_10_seg.txt")
    iterationsSEG2, yieldsSEG2 = readFromFile("300_trials_10_brute.txt")
    ...
    plt.title(
        "SSA Yield rate performance against different segmentations on IBM10Q2B (300 trials)")
