...
if __name__ == "__main__":
    iterationsSEG1, yieldsSEG1 = readFromFile("100_30_trials_seg_big.txt")
    iterationsSEG2, yieldsSEG2 = readFromFile("100_30_trials_brute.txt")
    ...
    plt.title(
        "SSA Yield rate performance against different segmentations on IBM30Q2B (100 trials)")
