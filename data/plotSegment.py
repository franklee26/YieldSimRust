...
if __name__ == "__main__":
    iterationsSEG1, yieldsSEG1 = readFromFile("300_trials_segment1.txt")
    iterationsSEG2, yieldsSEG2 = readFromFile("300_trials_segment2.txt")
    iterationsSEG3, yieldsSEG3 = readFromFile(
        "300_trials_segment3.txt")
    ...
    print("SEG1: {:.3f} {:.3f}".format(
        meanIterationsSEG1, meanYieldsSEG1))
    print("SEG2: {:.3f}, {:.3f}".format(meanIterationsSEG2, meanYieldsSEG2))
    print("SEG3: {:.3f} {:.3f}".format(
    ...
    plt.scatter(iterationsSEG1, yieldsSEG1, label="SEG1", c="blue")
    ...
    plt.scatter(iterationsSEG2, yieldsSEG2, label="SEG2", c="red")
